...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(0, 139, 255),
			Divider = Color3.fromRGB(60, 60, 60),
			Text = Color3.fromRGB(255, 255, 255),
			TextDark = Color3.fromRGB(0, 139, 255)
		}
	},
...
CreateElement("Label", function(Text, TextSize, Transparency)
	local Label = Create("TextLabel", {
		Text = Text or "",
		TextColor3 = Color3.fromRGB(0, 139, 255),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 24), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(0, 139, 255), 1.2),
...
local WindowName = SetProps(MakeElement("Label", WindowConfig.Name, 14), {
    ...
    Text = "<font color='rgb(0, 139, 255)'>Hex</font> <font color='rgb(255, 255, 255)'>X | BrookHaven | • </font> <font color='rgb(255, 139, 0)'>NEW SEASON</font> <font color='rgb(255, 255, 255)'> •</font>" -- Używamy tagów <font color='rgb(R, G, B)'>tekst</font>
})
