...
Stroke = Color3.fromRGB(191, 255, 242),
Divider = Color3.fromRGB(60, 60, 60),
Text = Color3.fromRGB(191, 255, 242),
TextDark = Color3.fromRGB(191, 255, 242)
		}
	},
...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/kigredns/icos/main/icons.json")).icons
end)
...
CreateElement("Label", function(Text, TextSize, Transparency)
	local Label = Create("TextLabel", {
		Text = Text or "",
    TextColor3 = Color3.fromRGB(191, 255, 242),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
      ...
      MakeElement("Stroke", Color3.fromRGB(191, 255, 242), 1.2),
			MakeElement("Padding", 12, 12, 12, 12),
			SetProps(MakeElement("Image", NotificationConfig.Image), {
				Size = UDim2.new(0, 20, 0, 20),
        ImageColor3 = Color3.fromRGB(191, 255, 242),
				Name = "Icon"
			}),
